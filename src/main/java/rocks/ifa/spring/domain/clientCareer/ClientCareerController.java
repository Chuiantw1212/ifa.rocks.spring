...
public class ClientCareerController {
    ...
    public ResponseEntity<CareerRes> getCareer(@PathVariable UUID clientId) {
    ...
    @SecurityRequirement(name = "bearerAuth")
    public ResponseEntity<Void> updateCareer(@PathVariable UUID clientId, @RequestBody @Valid UpdateCareerReq req) {
        String requesterUid = SecurityUtils.getCurrentUserUid();
